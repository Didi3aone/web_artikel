				...
				<div class="jarviswidget" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
					...
					<div>
						...
						<div class="widget-body no-padding">
							...
							<form id="form" class="smart-form" method="POST" action="<?php echo site_url('manager/artikel_video/process_form') ?>">
								<?php if($id != '' ) :?>
								...
								<fieldset>
									<div class="row">
										<section class="col col-6">
											...
											<label class="input"> 
												<input type="text" name="judul" value="<?= $judul; ?>" placeholder="Judul Video">
											</label>
										</section>
									...
									<footer>
										...
										<a href="<?= site_url() ?>manager/article-video" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Cancel</a>
									</footer>
								</fieldset>
							</form>
						</div>
